...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in relative max-w-6xl mx-auto">
      <section className="bg-gradient-to-r from-primary-700 to-blue-600 dark:from-slate-800 dark:to-slate-900 rounded-2xl shadow-lg p-8 text-white relative overflow-hidden flex items-center justify-center">
