                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-slate-700">
                            {filteredQuotations.map(quo => (
                                <tr key={quo.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors group">
                                    ...
                                    <td className="p-5">
                                        <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full ${quo.status === 'ACCEPTED_TO_PLAN' ? 'bg-emerald-100 text-emerald-700 border border-emerald-200' : 'bg-gray-100 text-gray-600 border border-gray-200'
                                            }`}>{quo.status}</span>
                                    </td>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-5xl p-8 flex flex-col max-h-[95vh] border border-white/20">
                        <div className="flex justify-between items-center mb-6 border-b pb-4 dark:border-slate-700">
                            <div className="flex items-center gap-4">
                                <div className="p-1 bg-white dark:bg-slate-700 rounded-2xl shadow-inner w-16 h-16 flex items-center justify-center overflow-hidden border border-gray-100 dark:border-slate-600">
