...
export const MOCK_TECHNICIANS: Technician[] = [
  { id: 'T-CASULA', name: 'Casula Federico', email: 'federico.casula@sicurant.it', color: '#0d9488' },
  { id: 'T-ATZENI', name: 'Atzeni Federico', email: 'federico.atzeni@sicurant.it', color: '#ea580c' },
  { id: 'T-CIRRONIS', name: 'Cirronis Matteo', email: 'matteo.cirronis@sicurant.it', color: '#16a34a' },
  { id: 'T-PAUSICH', name: 'Pausich Cristiano', email: 'cristiano.pausich@sicurant.it', color: '#c026d3' },
  { id: 'T-ZACCHEDDU', name: 'Zaccheddu Alessandro', email: 'alessandro.zaccheddu@sicurant.it', color: '#0891b2' },
  { id: 'T-USAI', name: 'Usai Mario', email: 'mario.usai@sicurant.it', color: '#dc2626' },
  { id: 'T-ERBI', name: 'Erbì Alessandro', email: 'alessandro.erbi@sicurant.it', color: '#2563eb' },
  { id: 'T-CABRIOLU', name: 'Cabriolu Marco', email: 'marco.cabriolu@sicurant.it', color: '#4f46e5' },
  { id: 'T-VACCA', name: 'Vacca Gianpiero', email: 'gianpiero.vacca@sicurant.it', color: '#db2777' },
  { id: 'T-MELIS', name: 'Melis Gianluca', email: 'gianluca.melis@sicurant.it', color: '#059669' },
  { id: 'T-TRUDU', name: 'Trudu Michele', email: 'michele.trudu@sicurant.it', color: '#4f46e5' },
  { id: 'T-CASTI-S', name: 'Casti Samuele', email: 'samuele.casti@sicurant.it', color: '#65a30d' },
  { id: 'T-CASTI-L', name: 'Casti Lorenzo', email: 'lorenzo.casti@sicurant.it', color: '#d97706' },
];
